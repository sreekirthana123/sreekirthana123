...
| 📚 **Study Pilot** <br /> Intelligent AI study assistant that parses syllabus PDFs into optimized, priority-weighted daily schedules. <br /><br /> • Groq-powered Llama 3.1 LLM integration <br /> • Automated PDF extraction (pdfplumber) <br /> • Custom Aurora Teal dashboard UI <br /><br /> ![Streamlit](https://img.shields.io/badge/Streamlit-FF4B4B?style=flat-square&logo=streamlit&logoColor=white) ![GenAI](https://img.shields.io/badge/Agentic-AI-8a2be2) | 💡 **Coming Soon / Placeholder** <br /> [Add your next project description here or combine with another project] <br /><br /> • [Feature 1] <br /> • [Feature 2] <br /> • [Feature 3] <br /><br /> ![Tech](https://img.shields.io/badge/Tech-Badge-8a2be2) |
<br />
